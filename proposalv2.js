...
const angyuli = document.getElementById('angy uli');
const angy = document.getElementById('angy');
const angy1 = document.getElementById('angy1');
const angy2  = document.getElementById('angy2');
const angy3 = document.getElementById('angy3');
const angy4 = document.getElementById('angy4');
const angy5 = document.getElementById('angy5');
const baby = document.getElementById("baby");
const angy6 = document.getElementById("angy6");
const pretty = document.getElementById("pretty");
const pretty2 = document.getElementById("pretty2");
...
btt10.addEventListener("click", function (){
	bbtt10.style.opacity= "0";
	btt8.style.opacity= "0";	 
 btt3.style.opacity= "1";
 pretty2.style.opacity= "1";
